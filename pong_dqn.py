...
def updateBall(paddle1YPos, paddle2YPos, ballXPos, ballYPos, ballXDirection, ballYDirection):
    ...
    #past it
        ...
        is_lose = 1
        return [is_win, is_lose, done, score, paddle1YPos, paddle2YPos, ballXPos, ballYPos, ballXDirection, ballYDirection]
...
class PongGame:
    ...
    def getNextFrame(self, action, infos):
        ...
        [is_win, is_lose, done, score, self.paddle1YPos, self.paddle2YPos, self.ballXPos, self.ballYPos, self.ballXDirection, self.ballYDirection] = updateBall(self.paddle1YPos, self.paddle2YPos, self.ballXPos, self.ballYPos, self.ballXDirection, self.ballYDirection)
        #draw the ball
        drawBall(self.ballXPos, self.ballYPos)
      ...
      #  drawInfos(infos, action)
        ...
        return [[is_win, is_lose], done, score, image_data]
